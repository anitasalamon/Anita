...
Computational biologist with a PhD in Biochemistry & Molecular Genetics from UVA (2025). I build pipelines and tools for multi-omics data — single-cell RNA-seq, bulk RNA-seq, and pathway analysis — with a focus on cardiovascular disease, smooth muscle cells and metabolism.

My work has contributed to publications in *Nature Metabolism* and *Circulation*, with a first-author paper currently under revision in *Nature Metabolism*.
